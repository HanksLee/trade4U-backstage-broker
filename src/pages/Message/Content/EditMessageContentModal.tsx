    ...
    return (
      ...
      >
        <Form className="editor-form">
          ...
          {!messageContent && (
            <FormItem label="是否显示" {...getFormItemLayout(3, 13)}>
          ...
          <FormItem label="內容描述" {...getFormItemLayout(3, 19)}>
